 ...
 * Received on timeout URL if reversal times out
 */
@Schema(description = "Transaction reversal timeout callback from Daraja API")
public record TransactionReversalTimeoutCallback(
